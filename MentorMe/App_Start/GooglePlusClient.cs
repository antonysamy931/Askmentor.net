...
namespace MentorMe
{
    public class GooglePlusClient : OAuth2Client
    {
        ...
        protected override Uri GetServiceLoginUrl(Uri returnUrl)
        {
            ...
            uriBuilder.AppendQueryArgument("scope", "https://www.googleapis.com/auth/plus.login https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile");
